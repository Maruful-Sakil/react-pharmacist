...
const CreateSupplier=()=>{
    ...
    const handleSubmit=(event)=>{
        ...
        axios.post("http://127.0.0.1:8000/api/supplier/create",data).then((succ)=>{
    ...
    return(
        <form onSubmit={handleSubmit}>
            ...
            Confirm Password: <input value={conf_password} onChange={(e)=>{setCpassword(e.target.value)}} type="password"/><br/>
